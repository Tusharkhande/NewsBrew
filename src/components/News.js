...
export class News extends Component {
    ...
    async updateNews() {
        const url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=dd8888d0412e41a9b8ccc5dcbb330d72&page=${this.state.page}&pagesize=${this.props.pageSize}`;
